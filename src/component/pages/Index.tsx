        ...
        <div className="w-full max-w-screen overflow-hidden">
            ...
            <main className="bg-dark-primary text-white  flex flex-col gap-6 text-center ">
                <section className="flex flex-col gap-6 ">
                    ...
                    <div className="w-screen h-screen bg-cover bg-center m-auto pt-30 p-6 md:pl-48 md:pr-48  lg:pl-50 xl:pr-50" style={{ backgroundImage: `url(${bgAccueil})` }}>
                        <div className="flex flex-col gap-6 inset-0 bg-black/60  items-center justify-center ">
                            <h2 className="text-xl font-bold font-title lg:text-3xl">
                ...
                <section className="flex flex-col gap-6 p-6 md:m-auto">
