export default function Footer({isDarkMode}:{isDarkMode :boolean}) {
  return (
    <footer className={`${isDarkMode?  "bg-dark-accent" : "bg-dark-third " }  w-full flex justify-between items-center  h-9 max-sm:justify-center max-md:justify-center max-lg:justify-center md:py-8 md:text-2xl`}>
