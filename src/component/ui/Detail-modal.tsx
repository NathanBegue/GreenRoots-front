...
export default function DetailModal({ setIsOpenDetail, article, isOpenDetail, isDarkMode, }: { setIsOpenDetail: React.Dispatch<React.SetStateAction<boolean>>, article: Itrees, isOpenDetail: boolean, isDarkMode : boolean }) {
